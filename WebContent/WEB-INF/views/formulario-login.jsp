...
<body class="templatemo-bg-image-1">
	<div class="container">
		<div class="col-md-12">	
			...
			<form action="efetuaLogin" method="post"  class="form-horizontal templatemo-login-form-2" role="form" >
				<div class="row">
					<div class="col-md-12">
						<h1>Campeonato entre Amigos!</h1>
					</div>
				</div>
				<div class="row">
				        ...
				        <div class="form-group">
				          <div class="col-md-12">		          	
				            ...
				            <div class="templatemo-input-icon-container">
				            	...
				            	<input type="text" name="login" class="form-control" id="username" placeholder="">
				            </div>		            		            		            
				          </div>              
				        </div>
				        <div class="form-group">
